...
public class ItemServiceImpl implements ItemService {
    ...
    public Item createItem(ItemDTO itemDTO) {
        ...
        if(itemDTO.getName()==null || itemDTO.getImg_url()==null || itemDTO.getName().isEmpty() || itemDTO.getImg_url().isEmpty())
        {
            throw new IllegalArgumentException("Item must not have null values");
        }
